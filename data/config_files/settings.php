 ...
 *
 */
$drupal_hash_salt = 'IouG7z9n2MH56Q_tUM0jn4vjLWWHCtE5LkMEC_51IC4';
...
# stage_file_proxy is awesome for mirroring files from a production site,
# so that you don't have to download gigs of data just to test a small fix.
# Because this settings.php is generic, we don't have anywhere to point it.
# But we leave this in case you use this file as a base for something else.
# The example below passes the .htaccess parameters (un: user, pw: password)

# Dev-Only, stage_file_proxy module settings.
#$conf['stage_file_proxy_origin'] = 'http://user:password@alpha.example.com';
...
# module, you may need to find a different approach for this.
